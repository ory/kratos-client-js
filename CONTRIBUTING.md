...
# Contribute to Ory Ory Kratos JavaScript Client<!-- omit in toc -->
...
Ory Kratos JavaScript Client's direction. A great way to
do this is via
...
- **Help with open issues.** We have a lot of open issues for Ory Ory Kratos JavaScript Client and
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/kratos-client-js/blob/master/.github/workflows/conventional_commits.yml)
